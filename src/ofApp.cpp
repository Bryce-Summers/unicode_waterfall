...
void ofApp::loadFonts()
{
    ...
    font.load("verdana.ttf", 44, true, true);
    font.setLineHeight(18.0f);
    font.setLetterSpacing(1.037);

    verdana14.load("verdana.ttf", 34, true, true);
